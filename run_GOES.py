from GOES_funcs import process_files, get_filelist
import datetime
import argparse
...
parser.add_argument('--hour', action='store', type=int, default=None, help='lon/lat limits for plotting')
...
filelist = get_filelist(year, day_of_year, bool(args.daytime), hour=args.hour)
